...
public class SwitchNode<T, U extends T, R>{
	 ...
	 * @param result
	 *            The function, that returns the result, to call when this value compares to the input value
	 * @return A new node that can be used to add more cases or execute this statement with the {@link #go()} method
	 */
	public SwitchNode<T, U, R> caseIf(U value, Function<U, R> result){
		if(this.value != null){
